...
License: none
*/
require_once( '/Applications/MAMP/htdocs/wordpress 2/wp-load.php' );
require_once( '/Applications/MAMP/htdocs/wordpress 2/wp-admin/includes/file.php' );
global $wpdb;
//echo get_post_type();
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.2/jquery.min.js"></script></script>
					...
					<script>
						$(document).ready(function(){
							...
							$.ajax({
					 					type : 'POST',
					 					url : '<?php ABSPATH; ?>wp-content/plugins/like_widget/like.php',
					 					data:{data:likeObj},
					 					...
					 					success:function(data){
					 						...
					 						var obj = JSON.parse(data);
					 							for(var key in obj){
							 						...
							 						+ date_liked + "</td><td><a id='delete'> delete </a> </td> </tr> ");
					 							}					 						
